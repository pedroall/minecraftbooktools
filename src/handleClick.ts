...
export function handleClick() {
    const button = <HTMLButtonElement>document.getElementById('convertor')
    button.addEventListener('click', async() => {
        const input = <HTMLInputElement>document.getElementById('bookfile')
        ...
        const div = <HTMLDivElement>document.getElementById('books')
